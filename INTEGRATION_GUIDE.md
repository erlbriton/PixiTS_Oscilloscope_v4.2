...
После проверки записи из Базы в контроллер на нескольких девайсах - нужно убрать диагностические warn из цикла записи.
___________________________________________________________________________________________________________________
Частота вывода значений величины параметров в осциллографе :  файл src/oscilloscope/ui/ChannelRow.ts Строка: 
